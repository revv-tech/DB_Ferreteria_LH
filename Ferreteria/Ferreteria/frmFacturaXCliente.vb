...
Public Class frmFacturaXCliente
    Private Sub frmFacturaXCliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenarComboClientes()
    End Sub
    ...
    Private Sub Cliente_Click(sender As Object, e As EventArgs) Handles Cliente.Click
        If (Cliente_cbx.Text <> "") Then
            ...
            sqlCon.Open()
            Dim cmd As New SqlCommand("sp_FacturaXCliente", sqlCon)
            'Tipo de comando'
