...
Public Class frmFacturas
    ...
    Private Sub NuevoButton_Click(sender As Object, e As EventArgs) Handles NuevoButton.Click
        If (Me.ValidateChildren = True And Local_cbx.Text <> "") And (Me.ValidateChildren = True And Empleado_tbx.Text <> "") And (Me.ValidateChildren = True And Cliente_ID.Text <> "") And (Me.ValidateChildren = True And Dir_Tbx.Text <> "") And (Me.ValidateChildren = True And TipoVenta_cbx.Text <> "") And (Me.ValidateChildren = True And Dir_Tbx.Text <> "") And (Me.ValidateChildren = True And Subtotal_tbx.Text <> "") Then
            Try
                ...
                ep.LocalId = Local_cbx.SelectedIndex + 1
                ep.Cliente_ = Cliente_ID.Text
                ep.TipodePago_ = TipoVenta_cbx.SelectedIndex + 1
